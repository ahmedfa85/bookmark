...
class __TwigTemplate_79413629d12c651b71c95fb194f641899cad004cb7ab21ce7567476c614e1bda extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"
    ...
    ";
        // line 12
        if ((0 !== \MailPoetVendor\twig_compare(($context["animation"] ?? null), ""))) {
            // line 13
  ...
  <div
    ...
    ";
        // line 30
        if ((((0 === \MailPoetVendor\twig_compare(($context["form_type"] ?? null), "popup")) || (0 === \MailPoetVendor\twig_compare(($context["form_type"] ?? null), "fixed_bar"))) || (0 === \MailPoetVendor\twig_compare(($context["form_type"] ?? null), "slide_in")))) {
            // line 31
            echo "      <img
  ...
  ";
    ...
    {
        return new Source("", "form/front_end_form.html", "C:\\laragon\\www\\bookmark\\wp-content\\plugins\\mailpoet\\views\\form\\front_end_form.html");
    }
}
